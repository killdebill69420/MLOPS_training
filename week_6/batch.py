...
def read_data_from_s3():
    ...
    result_file = "s3://nyc-duration/yellow_tripdata_2023-01.parquet"
    df_result = pd.read_parquet(result_file, storage_options=storage_options)
    return df_result
...
def main(year, month):
    ...
    #save_data(output_file, categorical)
